...
public class CustomizedExceptionHandlerConfig extends ResponseEntityExceptionHandler {
	 ...
	 * 
	 * @param request
	 * @param userCustomExceptions
	 * @return
	 */
	@ExceptionHandler(value = { UserCustomExceptions.class })
	@ResponseStatus(HttpStatus.NOT_FOUND)
	protected ResponseEntity<Object> handleException(HttpServletRequest request,
			UserCustomExceptions userCustomExceptions) {
		ExceptionsResponse exception = new ExceptionsResponse(HttpStatus.NOT_FOUND, userCustomExceptions.getMessage(),
