		var sampleData08 = [
                ...
                var sampleData08NextID = sampleData08.length + 1;

                function getIndexById(id) {

                    var idx,
                    l = sampleData08.length;

                    for (var j; j < l; j++) {
                        if (sampleData08[j].ProductID == id) {
                            return j;
                        }
                    }
                    return null;
                ...
                $(document).ready(function() {
                    $("#orderacdetails").kendoGrid({
                        dataSource: {
                            transport: {
                                read: function (e) {
                                    e.success(sampleData08);
                                },
                                create: function (e) {
                                    e.data.ProductID = sampleData08NextID++;
                                    sampleData08.push(e.data);
                                    e.success(e.data);
                                },
                                update: function (e) {
                                    sampleData08[getIndexById(e.data.ProductID)] = e.data;
                                    e.success();
                                },
                                destroy: function (e) {
                                    sampleData08.splice(getIndexById(e.data.ProductID), 1);
                                    e.success();
                                }
                            },
                            error: function (e) {
