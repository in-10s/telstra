  ...
  Payment.fns = {
    ...
    validateCardNumber: function(num) {
      ...
      if (!card) {
        ...
        document.getElementById("creditcard-input-field").style.borderColor="red";
      }
    ...
    validateCardExpiry: function(month, year) {
      ...
      if (!(month && year)){
        document.getElementById("creditcard-input-field").style.borderColor="red";999
        return false;
      }
      month = QJ.trim(month);
      year = QJ.trim(year);
